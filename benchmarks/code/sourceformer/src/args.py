...
def build_parser():
	...
	parser.add_argument('-just_write_stats', type=bool, default=False)

	# Mode specifications
	parser.add_argument('-mode', type=str, default='test', choices=['train', 'test'], help='Modes: train, test')
	...
	parser.add_argument('-dataset', type=str, default='cv_asdiv-a', help='Dataset') #mawps-asdiv-a_svamp, 
